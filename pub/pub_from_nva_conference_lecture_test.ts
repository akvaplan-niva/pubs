...
Deno.test("NVA", async (t) => {
  await t.step("Conference Lecture", async () => {
    ...
    const nva = "01907a95b7e5-0a61bd8c-cdde-4b31-b27a-1da198da19b9";
    const id = "https://api.test.nva.aws.unit.no/publication/" + nva;
    const expected = {
      id,
      parent: undefined,
      doi: undefined,
      ...
      authors: [{ family: "Viljanen", given: "Martta" }, {
        family: "Majaneva",
        given: "Sanna Kristiina",
      }],
